...
/**
 * below code for fetching and submitting data 
 */
...
// // }
/**
 * below code for submitting data... 
 */
$pri = ['development' => 1, 'testing' => 2, 'projectmanagement' => 3, 'research' => 4, 'meetings' => 5, 'training' => 6, 'support' => 7];
// $pri_rev = [1 => 'development', 2 => 'testing', 3 => 'projectmanagement', 4 => 'research', 5 => 'meetings', 6 =>  'training', 7 => 'support'];
        ...
        <div class="  text-center ">
            <form action="" id='form' method='post'>
                <div class="row mt-5">
                    <div class="col">
                        <label>Date</label>
                        <input type="date" class="dateFormat" name="datee" value="<?php echo htmlspecialchars($date); ?>" disabled>
                    </div>
                </div>
                <div class="row ms-2">
                    <div class="col-6 ">
                        ...
                        <div class="row pe-2 border px-0">
                            ...
                            <div class=" w-100 border border-dark px-0" id='addingCon'>
                                ...
                                // // Convert start_time to hours and minutes
                                // $start_hours = floor($data['start_time'] / 60);
                                // $start_minutes = $data['start_time'] % 60;

                                // // Convert end_time to hours and minutes
                                // $end_hours = floor($data['end_time'] / 60);
                                // $end_minutes = $data['end_time'] % 60;
                                // // for ($i = 1; $i <= 5; $i++) { 
                                // echo "  <div class='row px-1 mx-1 mb-2 w-100 d-flex'>
